        ...
        class ClickPlacement : IPlacement
        {
            ...
            public void Repaint(EditorWindow window)
            {
                ...
                if (m_PreviewInstantiation == null)
                {
                    ...
                    if (m_PreviewInstantiation.Collider != null)
                    {
                        m_PreviewInstantiation.Collider.gameObject.layer = LayerMask.NameToLayer("Ignore Raycast");
                        m_PreviewCollision = m_PreviewInstantiation.Collider.gameObject
                            .AddComponent<PlateauSandboxPlacementCollision>();

                        Rigidbody rigidbody = m_PreviewInstantiation.Collider.gameObject
            ...
            public void MouseMove(EditorWindow window)
            {
                ...
                switch (m_Context.PlacementSettings.Location)
                {
                    case PlacementLocation.PlaceOnSurface:
                    {
                        ...
                        m_PlacePoint = new PlacePoint(raycastHit.point, raycastHit.normal, null);
                        break;
                    }
                    ...
                    case PlacementLocation.PlaceAlongTrack:
                    {
                        ...
                        else
                        {
                            ...
                            m_PlacePoint = new PlacePoint(position, up, track);
